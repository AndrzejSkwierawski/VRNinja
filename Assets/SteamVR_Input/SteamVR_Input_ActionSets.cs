...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_BladeSet p_BladeSet;
        ...
        public static SteamVR_Input_ActionSet_BladeSet BladeSet
        {
            get
            {
                return SteamVR_Actions.p_BladeSet.GetCopy<SteamVR_Input_ActionSet_BladeSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_BladeSet = ((SteamVR_Input_ActionSet_BladeSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_BladeSet>("/actions/BladeSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.BladeSet};
        }
    }
}
